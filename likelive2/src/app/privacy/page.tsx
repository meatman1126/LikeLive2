  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col gap-6 px-6 py-12">
      ...
      <div className="space-y-6 rounded-lg border border-black/[.08] bg-white p-6 shadow-lg dark:border-white/[.145]">
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">第1条（個人情報）</h2>
          <p>
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">第4条（利用目的の変更）</h2>
          <p>
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">第6条（個人情報の開示）</h2>
          <p>
